...
export class PaymentList extends Component {
    ...
    render() {
        if (this.props.payments === null) {
            return <div>there are no payment records.</div>
        }
            ...
            <div className="list-group">
                <div className="list-group-item header">
                    <div className="row">
                        ...
                        <div className="col-xs-6 col-sm-2 text-right pull-right">Balance</div>
                        <div className="col-xs-6 col-sm-2 text-right pull-right">Amount</div>
